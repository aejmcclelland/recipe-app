    ...
    return (
        <Container maxWidth="md">
            <Box mt={4} mb={4}>
                ...
                <Typography variant="body1" gutterBottom>We may collect and process the following types of information:</Typography>

                <Typography variant="h6" gutterBottom>1.1 Information You Provide</Typography>
                <List>
                    <ListItem>
                ...
                <List>
                    <ListItem><ListItemText primary="• Provide and improve our application." /></ListItem>
                    <ListItem><ListItemText primary="• Personalize your experience, including displaying saved recipes and bookmarks." /></ListItem>
                    <ListItem><ListItemText primary="• Respond to support requests." /></ListItem>
                    <ListItem><ListItemText primary="• Send notifications related to your account or application updates (if applicable)." /></ListItem>
                </List>

                <Typography variant="h5" gutterBottom>3. Sharing Your Information</Typography>
                <Typography variant="body1" gutterBottom>
                    We do not sell or rent your personal data to third parties. We may share your data:
                </Typography>
                <List>
                    <ListItem><ListItemText primary="• With service providers: For hosting, analytics, and application maintenance." /></ListItem>
                    <ListItem><ListItemText primary="• As required by law: To comply with legal obligations or respond to lawful requests." /></ListItem>
                </List>

                <Typography variant="h5" gutterBottom>4. Data Retention</Typography>
                <Typography variant="body1" gutterBottom>
                ...
                <Typography variant="body1" gutterBottom>You have the right to:</Typography>
                <List>
                    <ListItem><ListItemText primary="• Access, update, or delete your personal information." /></ListItem>
                    <ListItem><ListItemText primary="• Opt-out of non-essential data collection or email communications." /></ListItem>
                    <ListItem><ListItemText primary="• Withdraw consent for the processing of your data." /></ListItem>
                </List>
